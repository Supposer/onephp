        ...
        public function thumb($filename,$new_w=160,$new_h=120,$cut=0,$big=0){
	        ...
	        if(!empty($info[0])) {
	            ...
	            if($type!='gif' && function_exists('imagecreatetruecolor')){
	                ...
	                $newimg = imagecreate($new_w, $new_h);
	            }
	             // 创建白色填充缩略画布  
	        	...
	        	$paddingx = (int)($new_w - $width) / 2;  
	        	$paddingy = (int)($new_h - $height) / 2;  
	        	
	            // 复制图片
	            if(function_exists("ImageCopyResampled")){
	                ImageCopyResampled($newimg, $oldimg, $paddingx, $paddingy, $start_w, $start_h, $width, $height, $end_w,$end_h);
	            } else{
	                ImageCopyResized($newimg, $oldimg, $paddingx, $paddingy, $start_w, $start_h, $width, $height, $end_w,$end_h);
	            }
